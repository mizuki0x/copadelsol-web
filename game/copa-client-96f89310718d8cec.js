/**
 * Open an online 1v1: dial `room_url` on the hosted signaling server and,
 * once an opponent joins the same room, start the rollback session (see
 * `copa_client::connect`). TURN urls are comma-separated and the page
 * fetches the credentials at connect time; empty strings run STUN-only.
 * The started peer is drained into a session by the shell's `online_pump`.
 * @param {string} room_url
 * @param {string} turn_urls
 * @param {string} turn_username
 * @param {string} turn_credential
 */
export function copa_connect_online(room_url, turn_urls, turn_username, turn_credential) {
    const ptr0 = passStringToWasm0(room_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(turn_urls, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(turn_username, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(turn_credential, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    wasm.copa_connect_online(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
}

/**
 * @param {string} socket_url
 * @param {string} socket_token
 * @param {number} local_seat
 * @param {bigint} replay_match_id
 * @param {bigint} seed
 * @param {string} seat_a
 * @param {string} seat_b
 * @param {number} club_a
 * @param {number} club_b
 */
export function copa_connect_paid(socket_url, socket_token, local_seat, replay_match_id, seed, seat_a, seat_b, club_a, club_b) {
    const ptr0 = passStringToWasm0(socket_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(socket_token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(seat_a, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(seat_b, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.copa_connect_paid(ptr0, len0, ptr1, len1, local_seat, replay_match_id, seed, ptr2, len2, ptr3, len3, club_a, club_b);
    if (ret[1]) {
...
/**
 * The compiled-in hosted signaling default — the base URL of the
 * production matchbox server (`copa_netcode::matchbox::DEFAULT_SIGNALING`).
 * The page reads this as the fallback of its signaling resolver
 * (`?signaling=` / `window.COPA_SIGNALING`), so the URL lives in one place
 * (Rust) and JS never restates it.
 * @returns {string}
 */
export function copa_default_signaling() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.copa_default_signaling();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
/**
 * Deliver one complete account snapshot as a `CPF1` frame (see
 * `copa_client::fetch` for the format and the all-or-nothing rules).
 * Throws the parse error back to the page on a malformed frame,
 * leaving any pending snapshot untouched.
 * @param {Uint8Array} frame
 */
export function copa_feed(frame) {
    const ptr0 = passArray8ToWasm0(frame, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.copa_feed(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
/**
 * The latest goal-clip GIF's sequence number (0 until the first goal).
 * The page polls this to detect a freshly-scored goal, then reads the
 * bytes via [`copa_take_goal_gif`]. Latest-wins: a new goal replaces the
 * prior clip.
 * @returns {bigint}
 */
export function copa_goal_gif_seq() {
    const ret = wasm.copa_goal_gif_seq();
    return BigInt.asUintN(64, ret);
}

/**
 * The online-match readout as JSON (connection state, ICE path, local
 * seat, current frame, rollback/desync counters, and the settled record
 * digest). The page polls this to render the soak overlay.
 * @returns {string}
 */
export function copa_online_stats() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.copa_online_stats();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
/**
 * The active program id (base58), so the page never restates it and
 * queries exactly the program this build binds PDAs against.
 * @returns {string}
 */
export function copa_program_id() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.copa_program_id();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
/**
 * Repoint this build at a different `copa` deployment before the first
 * poll (the page resolves `?program=` / `window.COPA_PROGRAM_ID`). Throws
 * a malformed id back to the page rather than silently querying a dead
 * address; a valid id becomes the id `copa_program_id` returns.
 * @param {string} id
 */
export function copa_set_program_id(id) {
    const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.copa_set_program_id(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
...
/**
 * The latest goal-clip GIF bytes (empty until the first goal). Returns a
 * fresh copy each call — the mailbox is latest-wins, not drain-once — so a
 * share/download link stays usable through the celebration. The encode
 * fires once per goal edge (`encode_goal_gif`), never per poll.
 * @returns {Uint8Array}
 */
export function copa_take_goal_gif() {
    const ret = wasm.copa_take_goal_gif();
 ...
 * @returns {Uint8Array}
 */
export function copa_take_online_replay() {
    const ret = wasm.copa_take_online_replay();
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 41920, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h334723e27d49e227);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 41977, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c);
            return ret;
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Array<any>"), NamedExternref("ResizeObserver")], shim_idx: 44327, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hc7a62176a014dc61);
            return ret;
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Array<any>")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_4);
            return ret;
        },
        __wbindgen_cast_0000000000000006: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("CloseEvent")], shim_idx: 41977, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_5);
            return ret;
        },
        __wbindgen_cast_0000000000000007: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("ErrorEvent")], shim_idx: 40703, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h09eaa67bff8ba58b);
            return ret;
        },
        __wbindgen_cast_0000000000000008: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Event")], shim_idx: 41977, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_7);
            return ret;
        },
        __wbindgen_cast_0000000000000009: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("Event")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_8);
            return ret;
        },
        __wbindgen_cast_000000000000000a: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("FocusEvent")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_9);
            return ret;
        },
        __wbindgen_cast_000000000000000b: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("KeyboardEvent")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_10);
            return ret;
        },
        __wbindgen_cast_000000000000000c: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 44477, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hd38158131c9eb721);
            return ret;
        },
        __wbindgen_cast_000000000000000d: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("PageTransitionEvent")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_12);
            return ret;
        },
        __wbindgen_cast_000000000000000e: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("PointerEvent")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_13);
            return ret;
        },
        __wbindgen_cast_000000000000000f: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("RTCPeerConnectionIceEvent")], shim_idx: 41977, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_14);
            return ret;
        },
        __wbindgen_cast_0000000000000010: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("WheelEvent")], shim_idx: 44324, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_15);
            return ret;
        },
        __wbindgen_cast_0000000000000011: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 41906, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h17b402fc5ed5ae66);
            return ret;
        },
        __wbindgen_cast_0000000000000012: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 42996, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h064720f2b17035ce);
            return ret;
        },
        __wbindgen_cast_0000000000000013: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 44333, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hb3942607e2217d84);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./copa-client_bg.js": import0,
    };
}

const lAudioContext = (typeof AudioContext !== 'undefined' ? AudioContext : (typeof webkitAudioContext !== 'undefined' ? webkitAudioContext : undefined));
function wasm_bindgen__convert__closures_____invoke__h17b402fc5ed5ae66(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h17b402fc5ed5ae66(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__h064720f2b17035ce(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h064720f2b17035ce(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__hb3942607e2217d84(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__hb3942607e2217d84(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_4(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_4(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_5(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_5(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h09eaa67bff8ba58b(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h09eaa67bff8ba58b(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_7(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_7(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_8(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_8(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_9(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_9(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_10(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_10(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hd38158131c9eb721(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hd38158131c9eb721(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_12(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_12(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_13(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_13(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_14(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__hd9df4e7a007e64a4_14(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_15(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h144b2848180ea29c_15(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h334723e27d49e227(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h334723e27d49e227(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__hc7a62176a014dc61(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__hc7a62176a014dc61(arg0, arg1, arg2, arg3);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('copa-client_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
